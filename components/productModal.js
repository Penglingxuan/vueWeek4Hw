      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content border-0">
            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="mb-2">
                  ...
                  <img :src="tempProduct.imagesUrl" alt="" class="img-fluid mb-3">
          ...
          <div class="modal-footer">
            ...
            <button v-if="modalType === '新增'" type="button" class="btn btn-primary" @click="postAddProducts">
              確認
            </button>
            <button v-else type="button" class="btn btn-primary" @click="updateProduct">
              確認
            </button>
          </div>
        </div>
